...
class Navbar extends Component {
  ...
  UserRequesting = () => {
    return axios.get("/api/findalltransUser").then(res => {
          ...
          <div>
            <nav>
              <div className="nav-wrapper z-depth-3">
                <a href="/home" className="center brand-logo">
                  ThisforThat
                </a>
                <a
                  href="#"
                ...
                <ul className="left hide-on-med-and-down">
                  ...
                  <li>
                    <a className="secondarytxt1">+ {this.state.recToken}</a>
                  </li>
                  <li>
                    <a className="secondarytxt2">- {this.state.sentToken} </a>
                  </li>
                </ul>
            ...
            <ul className="sidenav" id="mobile-demo">
              ...
              <li>
                ...
                <li>
                  <a className="secondarytxt1"> - {this.state.sentToken}</a>
                </li>
              </li>
            </ul>
          </div>
